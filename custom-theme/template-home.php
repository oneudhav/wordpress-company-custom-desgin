...
?>
        <main>
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <div class="carousel-image-wrap">
                                        <img src="<?php echo get_template_directory_uri(); ?>/images/slide/christina-wocintechchat-com-NDoVgcS_lZM-unsplash.jpg" class="img-fluid carousel-image" alt="">
                                    </div>
                                </div>
                                ...
                                <div class="carousel-item">
                                    ...
                                    <div class="carousel-image-wrap">
                                        <img src="<?php echo get_template_directory_uri(); ?>/images/slide/jason-goodman-0K7GgiA8lVE-unsplash.jpg" class="img-fluid carousel-image" alt="">
                                    </div>
                                </div>
          ...
          <?php require("template-projects.php"); ?>
